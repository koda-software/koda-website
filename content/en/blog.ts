...
export const blogContent: BlogUiContent = {
  ...
  seoTemplates: {
    ...
    categoryDescription: "Articles about {name} from the team building Opero at Koda Soft.",
    tagTitle: "{name} - Blog",
    tagDescription: "Articles tagged {name} from the team building Opero at Koda Soft.",
    authorTitle: "{name} - Blog",
    authorDescription: "Articles written by {name} for the Koda Soft blog.",
